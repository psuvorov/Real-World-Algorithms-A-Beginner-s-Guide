...
namespace Graph.Test
{
    ...
    public class UndirectedGraphTest
    {
        ...
        [Test]
        public void StackDeepFirstSearchWithDuplicates_ValidParamsPassed_Success()
        {
            string[] nodes = new[] {"0", "1", "2", "3", "4", "5", "6", "7"};
            UndirectedGraph<string> graph = new UndirectedGraph<string>(nodes);
            ...
            var visitedNodes = graph.StackDeepFirstSearchWithDuplicates();
            Assert.That(visitedNodes, Is.EquivalentTo(new string[] {"0", "3", "5", "7", "6", "4", "1", "2", "1"}));
        }
        ...
        {
            UndirectedGraph<string> graph = new UndirectedGraph<string>(new string[] {"A", "B", "C", "D", "E", "F", "G", "H", "I"});
            graph.SetEdge(0, 1);
        ...
        {
            UndirectedGraph<string> graph = new UndirectedGraph<string>(new string[] {"A", "B", "C", "D"});
            graph.SetEdge(0, 1);
            graph.SetEdge(1, 2);
            graph.SetEdge(2, 3);
            graph.SetEdge(1, 3);
