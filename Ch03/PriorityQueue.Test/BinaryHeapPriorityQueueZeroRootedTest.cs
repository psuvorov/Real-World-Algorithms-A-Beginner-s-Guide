...
{
    [TestFixture]
    public class BinaryHeapPriorityQueueZeroRootedTest
    {
        [Test]
        public void Insert_ValidParamsPassed_Success()
        {

            IPriorityQueue<int> priorityQueue = new BinaryHeapPriorityQueueZeroRooted<int>(5, (x, y) => y.CompareTo(x));
        ...
        public void Insert_QueueOverflow_Failure()
        {
            ...
            IPriorityQueue<int> priorityQueue = new BinaryHeapPriorityQueueZeroRooted<int>(4, (x, y) => y.CompareTo(x));
        ...
        public void Extract_ValidParamsPassed_Success()
        {
            ...
            IPriorityQueue<int> priorityQueue = new BinaryHeapPriorityQueueZeroRooted<int>(5, (x, y) => -x.CompareTo(y));
